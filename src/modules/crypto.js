...
var createCryptoModule = (() => {
  var _scriptDir =
    typeof document !== "undefined" && document.currentScript
      ? document.currentScript.src
      : undefined;

  return function (createCryptoModule) {
    createCryptoModule = createCryptoModule || {};

    var Module =
      typeof createCryptoModule !== "undefined" ? createCryptoModule : {};
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "/ChronoTools/crypto.wasm";
    if (!wasmBinaryFile) {
    ...
    var _decrypt = (Module["_decrypt"] = function () {
      return (_decrypt = Module["_decrypt"] = Module["asm"]["e"]).apply(
        null,
        arguments
      );
    });
    var _encrypt = (Module["_encrypt"] = function () {
      return (_encrypt = Module["_encrypt"] = Module["asm"]["f"]).apply(
        null,
        arguments
      );
    });
    ...
    return createCryptoModule.ready;
  };
})();
